...
// public Command commandMakeBarSpin(boolean APressed, boolean BPressed, boolean
// YPressed) {// makes, well, the bar
// // spin
// return runOnce(() -> {
// if (APressed) {
// setAlgaeArmVoltage(0.5);// מציין מיקום man it sure is nice to hide secret
// messages in hebrew hungarian
...
// return Commands.startEnd(() -> m_algaeBarMotor.set(ControlMode.PercentOutput,
// 0.6), // placeholder
...
// SmartDashboard.putNumber("Something bout sensor pos",
// m_algaeBarMotor.getSelectedSensorPosition());
// SmartDashboard.putNumber("Something bout sensor vel",
// m_algaeBarMotor.getSelectedSensorVelocity());
// SmartDashboard.putNumber("Something bout sensor current",
// m_algaeBarMotor.getSupplyCurrent());
